...
model = "Bridgeformer"
checkpoint_path = os.path.join('/root/autodl-tmp/experiments_v71214/checkpoints/', model, "7,12,14")
train_loss_path = os.path.join('/root/autodl-tmp/experiments_v71214/train_plot/', model, "7,12,14")
loss_save_path = os.path.join('/root/autodl-tmp/experiments_v71214/loss_and_prediction/', model, "7,12,14")
plot_save_path = os.path.join('/root/autodl-tmp/experiments_v71214/plot_save', model, "7,12,14")
